...
#ifndef VECTOR_CMPGT_H_
#define VECTOR_CMPGT_H_

#include "vector_struct.h"

//! Vector Compare Equal
__inline vector_t vector_cmpgt_float (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Compare Equal
__inline vector_t vector_cmpgt_sint (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Compare Equal
__inline vector_t vector_cmpgt_uint (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Compare Equal
__inline vector_t vector_cmpgt_char (vector_t a, vector_t b)
{
	vector_t vec;
