...
#ifndef VECTOR_CMPGE_H_
#define VECTOR_CMPGE_H_

#include "vector_struct.h"

//! Vector Compare Equal
__inline vector_t vector_cmpge_float (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Compare Equal
__inline vector_t vector_cmpge_sint (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Compare Equal
__inline vector_t vector_cmpge_uint (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Compare Equal
__inline vector_t vector_cmpge_char (vector_t a, vector_t b)
{
	vector_t vec;
