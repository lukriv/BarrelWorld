...
#ifndef VECTOR_ANY_EQ_H_
#define VECTOR_ANY_EQ_H_

#include "vector_struct.h"

__inline int vector_any_eq_float(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_any_eq_sint(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_any_eq_uint(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_any_eq_char(vector_t a, vector_t b)
{
	int temp = 0;
