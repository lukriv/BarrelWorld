...
#ifndef VECTOR_ANY_GE_H_
#define VECTOR_ANY_GE_H_

#include "vector_struct.h"

__inline int vector_any_ge_float(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_any_ge_sint(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_any_ge_uint(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_any_ge_char(vector_t a, vector_t b)
{
	int temp = 0;
