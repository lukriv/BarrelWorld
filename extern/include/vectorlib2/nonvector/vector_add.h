...
//! Vector Add
__inline vector_t vector_add_float (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Add
__inline vector_t vector_add_sint (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Add
__inline vector_t vector_add_uint (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Add
__inline vector_t vector_add_char (vector_t a, vector_t b)
{
	vector_t vec;
