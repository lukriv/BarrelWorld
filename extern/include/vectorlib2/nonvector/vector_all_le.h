...
#ifndef VECTOR_ALL_LE_H_
#define VECTOR_ALL_LE_H_

#include "vector_struct.h"

__inline int vector_all_le_float(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_all_le_sint(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_all_le_uint(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_all_le_char(vector_t a, vector_t b)
{
	int temp = 0;
