...
#ifndef VECTOR_ANY_LT_H_
#define VECTOR_ANY_LT_H_

#include "vector_struct.h"

__inline int vector_any_lt_float(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_any_lt_sint(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_any_lt_uint(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_any_lt_char(vector_t a, vector_t b)
{
	int temp = 0;
