...
#ifndef VECTOR_CMPEQ_H_
#define VECTOR_CMPEQ_H_

#include "vector_struct.h"

//! Vector Compare Equal
__inline vector_t vector_cmpeq_float (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Compare Equal
__inline vector_t vector_cmpeq_sint (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Compare Equal
__inline vector_t vector_cmpeq_uint (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Compare Equal
__inline vector_t vector_cmpeq_char (vector_t a, vector_t b)
{
	vector_t vec;
