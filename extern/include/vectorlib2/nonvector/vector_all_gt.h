...
#ifndef VECTOR_ALL_GT_H_
#define VECTOR_ALL_GT_H_

#include "vector_struct.h"

__inline int vector_all_gt_float(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_all_gt_sint(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_all_gt_uint(vector_t a, vector_t b)
{
	int temp = 0;
...
__inline int vector_all_gt_char(vector_t a, vector_t b)
{
	int temp = 0;
