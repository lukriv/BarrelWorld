...
#ifndef VECTOR_CMPLE_H_
#define VECTOR_CMPLE_H_

#include "vector_struct.h"

//! Vector Compare Equal
__inline vector_t vector_cmple_float (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Compare Equal
__inline vector_t vector_cmple_sint (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Compare Equal
__inline vector_t vector_cmple_uint (vector_t a, vector_t b)
{
	vector_t vec;
...
//! Vector Compare Equal
__inline vector_t vector_cmple_char (vector_t a, vector_t b)
{
	vector_t vec;
