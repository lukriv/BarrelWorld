...
static const wxChar* LOADMESHTEST_DEFINITION_FILE = 
	...
	wxT("  <meshdefs>\n")
	wxT("   <mesh name=\"mesh1\">\n")
	wxT("    <meshname value=\"TestingCube\" />\n")
	wxT("   </mesh>\n")
	wxT("  </meshdefs>\n")		
	wxT(" </definitions>\n")
	wxT("</world>");
...
static const wxChar* LOADMATERIALTEST_DEFINITION_FILE = 
	...
	wxT("    <materialname value=\"Test/ColourTest\" />\n")
	wxT("   </material>\n")
	wxT("  </materialdefs>\n")		
	wxT(" </definitions>\n")
	wxT("</world>");
...
static const wxChar* LOADCAMERA_DEFINITION_FILE = 
	...
	wxT("     <position xyz=\"0.0, 10.0, -5.0\" />\n")
	wxT("     <direction xyz=\"0, -10, 5\" />\n")
	wxT("    </camera>\n")
	wxT("   </cameradefs>\n")
	wxT(" </definitions>\n")
	wxT("</world>");
...
static const wxChar* LOADLOGIC_DEFINITION_FILE = 
	...
	wxT("   <logictype value=\"MANUAL_TEST\" />\n")
	wxT("  </logic>\n")
	wxT(" </logicdefs>\n")
	wxT(" </definitions>\n")
	wxT("</world>");
...
static const wxChar* LOADENTITYTEST1_DEFINITION_FILE = 
	...
	wxT("   <transform>\n")
	wxT("    <position xyz=\"0.0, 0.0, 0.0\" />\n")
	wxT("    <scale xyz=\"1.0, 1.0, 1.0\" />\n")
	wxT("    <rotation quat=\"1.0, 0.5, 0.3, 0.1\" />\n")		
	wxT("   </transform>\n")
