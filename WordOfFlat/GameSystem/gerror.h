...
static const wxChar* FWG_E_STREAM_EOF_ERROR_STR = wxT("FWG_E_STREAM_EOF_ERROR");

#define FWG_E_STREAM_WRITE_ERROR 0xE000000e
static const wxChar* FWG_E_STREAM_WRITE_ERROR_STR = wxT("FWG_E_STREAM_WRITE_ERROR");

#define FWG_E_STREAM_READ_ERROR 0xE000000f
static const wxChar* FWG_E_STREAM_READ_ERROR_STR = wxT("FWG_E_STREAM_READ_ERROR");
