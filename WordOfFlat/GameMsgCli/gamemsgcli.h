...
static const unsigned short int GAME_TCP_SERVICE_PORT = 9567;
static const unsigned short int GAME_UDP_SERVER_PORT = 9568;
static const unsigned short int GAME_UDP_CLIENT_PORT = 9569;
